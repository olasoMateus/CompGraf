 ...
 */
 ...
 /**  @type {Matrix4} */
 var thighMatrix = new Matrix4().setTranslate(3, -8, 0);
 /** @type {Matrix4} */
 ...
 /**  @type {Matrix4} */
 var thighMatrix2 = new Matrix4().setTranslate(-3, -8, 0);
 /** @type {Matrix4} */
 var legMatrix2 = new Matrix4().setTranslate(0, -5, 0);
 /** @type {Matrix4} */
 ...
 var thighMatrixLocal = new Matrix4().setScale(3, 5, 3);
 var legMatrixLocal = new Matrix4().setScale(2, 5, 2);
 var footMatrixLocal = new Matrix4().setScale(2, 1, 3);
 ...
 function handleKeyPress(event) {
   ...
   switch (ch) {
     ...
     case "m":
       thighAngle += 15;
       // rotate thigh clockwise about a point 2 units above its center
       var currentThighRot = new Matrix4()
          .setTranslate(0, 2, 0)
          .rotate(-thighAngle, 1, 0, 0)
          .translate(0, -2, 0);
       thighMatrix.setTranslate(3, -8, 0).multiply(currentThighRot);
       break;
     case "M":
      thighAngle -= 15;
       var currentThighRot = new Matrix4()
     ...
     case "n":
       legAngle -= 15;
       // rotate leg clockwise about its top front corner
     ...
     case "b":
       footAngle -= 15;
       footMatrix.setTranslate(0, -3, 1).rotate(footAngle, 1, 0, 0);
       break;
     case "B":
      footAngle += 15;
      footMatrix.setTranslate(0, -3, 1).rotate(footAngle, 1, 0, 0);
     ...
     case "c":
       ...
       var currentThighRot = new Matrix4()
           ...
           .translate(0, -2, 0);
       thighMatrix2.setTranslate(-3, -8, 0).multiply(currentThighRot);
       break;
     ...
     case "x":
       ...
       var currentLeg = new Matrix4()
           .setTranslate(0, 2.5, 1.0)
           .rotate(-legAngle2, 1, 0, 0)
           .translate(0, -2.5, -1.0);
       legMatrix2.setTranslate(0, -5, 0).multiply(currentLeg);
       break;
     ...
     case "z":
       footAngle2 -= 15;
       footMatrix2.setTranslate(0, -3, 1).rotate(footAngle2, 1, 0, 0);
       break;
 ...
 window.addEventListener("load", (event) => {
   ...
   lightingShader = initShaders(gl, vshaderSource, fshaderSource);
   gl.useProgram(null);
